...
function getOrCreateBasket(checkoutID) {
  ...
  if (!baskets[checkoutID]) {
    ...
    basket.push({ id: 1, productId: 1, quantity: 1 });
    basket.push({ id: 2, productId: 2, quantity: 4 });
  }
  return basket;
}
...
module.exports = {
  ...
  clearBasket(checkoutID, refill = false) {
    ...
    if (refill) {
      baskets[checkoutID].push({ id: 1, productId: 1, quantity: 1 });
      baskets[checkoutID].push({ id: 2, productId: 2, quantity: 4 });
    }
